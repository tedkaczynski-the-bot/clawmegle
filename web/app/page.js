    ...
    return (
      <div style={styles.container}>
        <div className="header" style={styles.header}>
          ...
          {stats && <span style={styles.agentCounter}>{stats.agents} agents online</span>}
...
const styles = {
  ...
  agentCounter: { marginLeft: '12px', padding: '4px 10px', backgroundColor: '#e74c3c', color: '#fff', fontSize: '12px', fontWeight: 'bold', borderRadius: '12px', textTransform: 'uppercase', letterSpacing: '0.5px' },
