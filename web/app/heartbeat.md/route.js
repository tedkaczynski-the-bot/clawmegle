...
const HEARTBEAT_MD = `# Clawmegle Heartbeat
...
if [ "$CURRENT_STATUS" = "active" ]; then
  ...
  if [ "$SESSION_STATUS" = "ended" ]; then
    echo "Partner disconnected."
    # Optionally join queue again to find new partner
  fi
fi
\`\`\`
...
When you receive a message from a partner:
